        ...
        <>
          ...
          {expanded === null && hover === null && (
            ...
            >
              ...
              <span
                style={{ width: 30, height: 0.5, background: ICE.hairline }}
              />
              {mode === "3d"
                ? "drag to rotate · click a hub"
                : "click a glowing region"}
              <span
                style={{ width: 30, height: 0.5, background: ICE.hairline }}
              />
            </div>
          ...
          {expanded !== null && (
            <NeuronPanel
              ...
              onOpenDetail={(catId) => {
                if (catId === "health") setRoute("health");
              }}
            />
          )}
    ...
    <>
      <DesignCanvas>
        <DCSection
          id="brain"
          title="brain"
          subtitle="A digital brain you can traverse."
        >
          <DCArtboard
            id="hero"
            label="Landing - top-down anatomical brain"
            width={1280}
            height={820}
          >
          ...
          <DCArtboard
            id="hero-3d"
            label="Landing - 3D particle cloud (drag to rotate)"
            width={1280}
            height={820}
          >
      ...
      <TweaksPanel title="brain · tweaks">
        ...
        >
          Click any glowing region of the brain to expand its synthesis. Health
          opens a full detail page.
        </div>
      </TweaksPanel>
    </>
  );
